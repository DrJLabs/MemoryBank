...
| ID | Task | Status |
|----|------|--------|
| **S0‑CG** | Coverage‑gate ≥ 80 % (`pytest‑cov`, Jest) | [x] |
| **S0‑PAR** | Parallel CI (`xdist`, matrix) | [x] |
| **S0‑FLKY** | Fix flaky DB isolation tests | [x] |
| **S0‑LIC** | Integrate FOSSA / ORT licence scan | [x] |
