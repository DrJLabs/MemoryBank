...
class TestBMADOrchestratorPersona:
    ...
    def test_persona_consistency(self, mock_agent_orchestrator, quality_metrics_tracker):
        ...
        responses = [
            ...
            "I'll transform into the dev agent to help with implementation.",
        ]
        
        # Act & Assert
        for response_text in responses:
            # Check that responses contain persona indicators
            ...
            # Persona adherence should be > 95%
            assert persona_percentage >= 0.5, f"Low persona adherence in: {response_text}"
